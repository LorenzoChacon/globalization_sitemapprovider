...
namespace SiteMapProviderGlobalizationDemo.DI.StructureMap.Registries
{
...
// Configure Security
            ...
            string resourceBaseName = "Language.Resources.SiteMap.Resources";

            // A reference to the assembly where your resources reside.
            Assembly resourceAssembly = typeof(Language.Resources.SiteMap.Resources).Assembly;
